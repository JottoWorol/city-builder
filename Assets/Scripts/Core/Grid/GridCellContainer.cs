...
namespace Core.Grid
{
    public class GridCellContainer
    {
        ...
        public GridCellContainer(StaticData staticData)
        {
        ...
        public bool TryGetRandomWalkablePosition(out Vector2Int position)
        {
            ...
            var randomIndex = UnityEngine.Random.Range(0, walkableCells.Count);
            position = walkableCells[randomIndex].GridCellData.Position;
            return true;
        }
        
        public bool TryGetCellByView(CellView view, out GridCell cell)
        {
            return _viewToCell.TryGetValue(view, out cell);
        }
